    ...
    render() {
        return (
            <Container maxwidth="md">
                ...
                right:"0",margin:"0 auto",borderRadius:"50%"}}>Dyslexia Help Center</h3>
                </div>
                <div style={{backgroundColor: "#F08080",borderRadius:"50px", border:"3px solid #40E0D0", marginBottom:"10px",marginTop:"-20px", color: "white", display: "flex", flexDirection: "row",marginTop:"7%",justifyContent: "center"}}>
